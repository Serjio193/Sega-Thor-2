...
- **PRE_D8_MINIMUM_EVENT_SAFETY**: **PASS for bb_06004000 bounded execution only** (two independent cold boots in Mednafen oracle proved atomic 28-cycle window [305462360..305462388; earlier '18-cycle' was an arithmetic/typographical error for 28] with 0 MMIO, 0 IRQ, 0 SCU DMA, and inactive Slave SH-2).
...
Active next verification step: **Post-D8 Second-Pass Method Experiments (docs/POST_D8_SECOND_PASS_PLAN.md / ADR D-012)**.
