#!/usr/bin/env python3
"""CTest integration test for M68K full BGM.BIN module round-trip verification."""
...
def main() -> int:
    ...
    # Ensure full BGM.BIN module assembly is generated
    s_path = os.path.join(repo_root, ".private", "asm", "BGM", "BGM.s")
    manifest_path = os.path.join(repo_root, "asm", "manifests", "BGM.BIN.json")
