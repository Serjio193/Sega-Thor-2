#!/usr/bin/env python3
"""CTest integration test for SH-2 full 0TH2.BIN module round-trip verification."""
...
def main() -> int:
    ...
    # Ensure full module assembly is generated
    ...
    if not os.path.exists(s_path):
        ...
        res_gen = subprocess.run([sys.executable, gen_script], cwd=repo_root)
