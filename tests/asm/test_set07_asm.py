#!/usr/bin/env python3
"""CTest integration test for SH-2 full SET07.BIN module round-trip verification."""
...
def main() -> int:
    ...
    # Ensure full SET07.BIN module assembly is generated
    s_path = os.path.join(repo_root, ".private", "asm", "SET07", "SET07.s")
    manifest_path = os.path.join(repo_root, "asm", "manifests", "SET07.BIN.json")
