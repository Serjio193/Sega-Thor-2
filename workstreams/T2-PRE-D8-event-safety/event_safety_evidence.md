...
- Between entry at cycle `305,462,360`, block exit at cycle `305,462,387` (exact 27-cycle block duration), and subsequent instruction boundary at cycle `305,462,388` (spanning the 28 master cycle event observation window: 305,462,388 - 305,462,360 = 28), zero SCU DMA transfers were scheduled or active.
